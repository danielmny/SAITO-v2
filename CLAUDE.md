# CLAUDE.md — Legacy Compatibility Note
> Founders OS now targets Codex as its primary runtime.

This file remains only as a compatibility pointer for older local workflows.
