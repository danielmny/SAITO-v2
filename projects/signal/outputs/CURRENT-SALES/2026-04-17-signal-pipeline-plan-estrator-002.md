...
source_run_id: RUN-20260417T1206330200-CURRENT-SALES-3e03f20e
status: completed
---
## Scope
Write the pipeline brief to outputs/CURRENT-SALES and identify where ATLAS-RESEARCH is needed to sharpen targeting.
...
- `outputs/handoffs/`
- `outputs/handoffs/HANDOFF-2026-04-13-MERIDIAN-ORCHESTRATOR-002.md`
- `outputs/state.json`
...
- `HANDOFF-2026-04-17-CURRENT-SALES-001` -> downstream handoff created.